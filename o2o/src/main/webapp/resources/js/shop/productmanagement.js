$(function() {
    // get productlist under this shop
     ...
     */
    function getList() {
        // get productlist of this shop from back end从后台获取此店铺的商品列表
        $.getJSON(listUrl, function(data) {
            if (data.success) {
                var productList = data.productList;
                var tempHtml = '';
                // traverse every product info, concat them to one line, 遍历每条商品信息，拼接成一行显示，列信息包括：
